...
const ENTREES = [
  ...
  { href: "/statistiques", libelle: "Statistiques", icone: "M4 20V10M10 20V4M16 20v-7M22 20H2" },
];
...
export function NavigationTablette({
  ...
  if (variante === "basse") {
    return (
      <nav className="no-print grid grid-cols-6 border-t border-brand-100 bg-white md:hidden">
        {ENTREES.map((e) => (
          <Link
            key={e.href}
            href={e.href}
